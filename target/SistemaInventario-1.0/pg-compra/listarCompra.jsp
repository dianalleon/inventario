...
%>
--%>
<jsp:useBean id="fachada" class="sistemainventarios.negocio.facade.CompraFacade"></jsp:useBean>
    <html>
        <head>
        ...
        <div>
        <%--            <button class="btn" onclick="location.href = 'compraForm.html'" style="top : 15%; left : 87%; position:relative"> --%>
        <button class="btn" id="nuevo" value="pg-compra/insertarCompra.jsp" style="left : 1.2%; position:relative;">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table id="tablaCompras" class="table table-bordered">
                ...
                <tbody>
                    <% for (Compra compra : fachada.buscarCompras()) {
                    %>
                    <tr>                               
                        ...
                        <td>
                            <button  class="item" style="border:none" value="pg-compra/mostrarCompra.jsp?idCompra=<%= compra.getIdCompra()%>">
                            ...
                            <button  class="item" style="border:none" value="pg-compra/eliminarCompra.jsp?idCompra=<%= compra.getIdCompra()%>">
