...
%>
--%>
<jsp:useBean id="fachada" class="sistemainventarios.negocio.facade.VentaFacade"></jsp:useBean>
    <html>
        <head>
        ...
        <button class="btn" id="nuevo" value="pg-venta/insertarVenta.jsp" style="left : 1.2%; position:relative;">
