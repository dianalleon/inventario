...
<html>
    ...
    <%
        if (true) {
            ...
            String idCompra3 = request.getParameter("idCompra2");
            ...
            //System.out.print("ojo1-idCompra2=" + idCompra3 + "&nombre2=" + nombre3 + "&precio2=" + precio3 + "&cantidad2=" + cantidad3 + "&iva2=" + iva3 + "&retencion2=" + retencion3 + "&cantidadMinima2=" + cantidadMinima3 + "&idCategoria2=" + idCategoria3 + "& nuevo2=" + nuevo3 + "&validar3=" + validar3);

            //System.out.print("filas " + filas3);
            String pagina = "";
            String msg3 = "";
            if (validar3.equals("1")) {
                Compra p = new Compra(idCompra3, idProveedor3, idEmpleado3, total3, fecha3, lista3);
                msg3 = fachada.insertarCompra(p, nuevo3);
    ...
    <script>
        $("#box").load("pg-compra/" + ($(esto).val()) + "?mens=" + ($(esto1).val()) + "&emple=" + ($(uid1).val()), function () {
        });
    </script>
    <%
                }
